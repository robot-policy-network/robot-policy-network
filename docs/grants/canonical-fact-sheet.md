...
| Fact | Status |
|---|---|
| Applicant / project lead identity ("Richard") | NEEDS CONFIRMATION |
| Applicant email and official contact | NEEDS CONFIRMATION |
| Legal entity: none; apply as individual, DBA "StonkRobotics" | NEEDS CONFIRMATION |
